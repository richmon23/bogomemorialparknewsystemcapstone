...
<body>
            ...
            <?php
                     ...
                     {
                        $student_id = $_GET['id'];
                        $query = "SELECT * FROM reservation WHERE id=:stud_id LIMIT 5";
        ...
        <center><img src="picture2.png"  alt="bogo memorial park" class="img"></center>
            <div class="container">
                <form action="code.php" method="POST">
                    ...
                    <div class="row mt-5">
                        <center> <h3 class="mt-">Update Reservation </h3></center>
                        <hr class="s-2 text-black">
                        <div class="col-lg-7 mt-5">
                            <input type="text" name="fullname" value="<?=$result['fullname'];?>" class="form-control" placeholder="Full name" aria-label="Full name" name="fullname" required>
                        </div>
                        <div class="col mt-5">
                            <input type="text" name="email" value="<?=$result['email'];?>" class="form-control" placeholder="Email" aria-label="email" name="email" required>
                        </div>
                        <br>
                        <div class="col-md-5 mt-4">
                            <input type="number" name="contact" value="<?=$result['contact'];?>" class="form-control" placeholder="Contact" aria-label="contact" name="contact" required>
                        </div>
                        ...
                        <div class="col-mt-12 mt-4">
                        <div class="input-group">
                        <!-- <label for="inputState" class="form-label">Plot Number</label> -->
							<select  id="inputState" class="form-select " name="statusaccount" required>
                        ...
                        <center>
                            <div class="button">
                                    <button type="submit" name="status"  class="btn submit mt-4">Update</button>
                                  <!-- <a href="userlogin.php"> <button type="reset" class="btn cancel mt-5 ">Cancel</button> </a>  -->
                                  <a href="admindashboard.php" class="btn cancel mt-4 ">Cancel</a>
                            </div>
                        </center>
                    </div>
                </form>    
